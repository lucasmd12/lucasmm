...
class Federation {
  final String id;
  final String name;
  final String? tag; // Adicionado - tag da federação
  ...
  factory Federation.fromJson(Map<String, dynamic> json) {
    return Federation(
      ...
      tag: json["tag"], // Adicionado
      leader: FederationLeader.fromJson(json["leader"] as Map<String, dynamic>? ?? {}), // Ensure leader is a Map
  ...
  Map<String, dynamic> toJson() {
    return {
      "_id": id,
      "name": name,
      if (tag != null) "tag": tag, // Adicionado
