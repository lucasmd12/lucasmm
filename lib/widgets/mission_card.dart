...
class MissionCard extends StatelessWidget {
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          _getMissionTypeDisplayName(mission.type),
                          style: TextStyle(
              ...
              if (mission.type == MissionType.clan || mission.type == MissionType.qrr)
                Padding(
  ...
  String _getMissionTypeDisplayName(MissionType type) {
    switch (type) {
      ...
      case MissionType.weekly:
        return 'Missão Semanal';
      case MissionType.clan:
      case MissionType.qrr:
        return 'Missão do Clã';
      case MissionType.special:
        return 'Missão Especial';
    }
  }
}
