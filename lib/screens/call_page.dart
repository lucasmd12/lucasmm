...
class _CallPageState extends State<CallPage> with TickerProviderStateMixin {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      if (!voipService.isInCall) {
        voipService.joinJitsiMeeting(
          ...
          userEmail: null, // Definido como null para respeitar a política de não-email
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Consumer2<CallProvider, VoIPService>( // Corrigido para VoIPService
  ...
  Widget _buildContactInfo(VoIPService voipService) { // Corrigido para VoIPService
  ...
  Widget _buildCallStatus(VoIPService voipService) { // Corrigido para VoIPService
    return Padding(
  ...
  Widget _buildCallControls(BuildContext context, VoIPService voipService) { // Corrigido para VoIPService
  ...
  Widget _buildActiveCallControls(BuildContext context, VoIPService voipService) { // Corrigido para VoIPService
    return Column(
      children: [
