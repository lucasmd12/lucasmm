...
import '../../models/chat_channel_model.dart'; // Use ChatChannelModel
...
class _ChatListTabState extends State<ChatListTab> {
  ...
  // CORREÇÃO: Usar ChatChannelModel, a filtragem pode ser feita depois se necessário
  ...
  Future<void> _loadVoiceChannels() async {
    ...
    try {
      ...
      // Assumindo que getClanChannels retorna List<ChatChannelModel>
      // e que queremos canais de voz (precisa ajustar o serviço ou filtrar aqui)
      // Vamos chamar com type='voice' (assumindo que o serviço suporta isso)
      final List<ChatChannelModel> channels = await _clanService!.getClanChannels(clanId, type: 'voice');
