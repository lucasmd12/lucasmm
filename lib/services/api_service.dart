...
class ApiService {
  ...
  Future<http.Response> _makeRequestWithRetry(Future<http.Response> Function() requestFunction, {int maxRetries = 2}) async {
    ...
    throw Exception('Max retries reached'); // Should not happen if maxRetries is 0 or more
  }
  ...
  Future<void> keepServerAlive() async {
    try {
      ...
      // O método 'get' agora é uma função, não um getter, então pode ser chamado diretamente.
