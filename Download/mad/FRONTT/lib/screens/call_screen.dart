...
class _CallScreenState extends State<CallScreen> {
  ...
  Widget _buildCallHeader(VoIPService voipService) { // Corrigido para VoIPService
    ...
    switch (call.status ?? CallStatus.pending) {
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          // Nome do usuário
          Text(
            widget.isIncoming ? 'Usuário ${call.callerId ?? 'Desconhecido'}' : 'Usuário ${call.receiverId ?? 'Desconhecido'}',
  ...
  Widget _buildCallControls(VoIPService voipService) { // Corrigido para VoIPService
    ...
    if ((call.status ?? CallStatus.ended) == CallStatus.pending && widget.isIncoming) {
